...
class MainWindow(QTabWidget):
    ...
    def __init__(self):
        ...
        self.setWindowIcon(QIcon("images/UI/shida.png"))
        # 图片读取进程
        ...
        self.model = self.model_load(weights="runs/train/exp_yolov5s/weights/best2.pt",
    ...
    ***界面初始化***
    ...
    def initUI(self):
        ...
        self.left_img.setPixmap(QPixmap("images/UI/shida.png"))
        self.right_img.setPixmap(QPixmap("images/UI/1.png"))
        ...
        self.vid_img = QLabel()
        self.vid_img.setPixmap(QPixmap("images/UI/shida.png"))
       ...
       # self.addTab(about_widget, '联系我')
        self.setTabIcon(0, QIcon('images/UI/shida.png'))
    ...
    ***上传图片***
    ...
    def upload_img(self):
        ...
        if fileName:
            ...
            # todo 上传图片之后右侧的图片重置，
            self.right_img.setPixmap(QPixmap("images/UI/shida.png"))
